...
public class AlbumPageController {
    ...
    @PostMapping("/{albumId}")
    public ResponseEntity<ApiUtils.ApiResult> createPage(@RequestBody AlbumPageRequestDTO requestDTO, @PathVariable Long albumId) throws JsonProcessingException {
